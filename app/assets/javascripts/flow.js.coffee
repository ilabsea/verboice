...
onWorkflow ->
  ...
  window.step_types = [SpeechRecognition, Play, Menu, Capture, Transfer, Goto, Branch, HangUp, Record, Language, MarkAsFailed, MarkAsSuccessful, HangUpAndCallBack, Nuntium, Impersonate, Personate, Datetime, Register, Deregister].concat(External.classes())
