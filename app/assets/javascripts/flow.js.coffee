...
onWorkflow ->
  ...
  window.step_types = [SpeechRecognition, Play, Menu, Capture, Transfer, Goto, Branch, HangUp, Record, Language, MarkAsFailed, MarkAsSuccessful, HangUpAndCallBack, Nuntium, Impersonate, Datetime, Register, Deregister].concat(External.classes())
