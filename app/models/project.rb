...
class Project < ActiveRecord::Base
  ...
  attr_accessible :name, :account, :status_callback_url, :status_callback_include_vars, :status_callback_url_user, :status_callback_url_password, :time_zone, :project_variables_attributes, :languages, :default_language, :store_call_log_entries
