...
describe CallFlowsController do
  ...
  let!(:channel) { Channels::Custom.make name: 'Channel1' }
  ...
  context "render_views" do
    ...
    it 'Should retrieve a csv with the call traces' do
      ...
      call_log1 = CallLog.make id: 1, address: 1000, channel: channel, call_flow: call_flow, direction: 'incoming', started_at: Time.now, finished_at: Time.now
      call_log2 = CallLog.make id: 2, address: 1000, channel: channel, call_flow: call_flow, direction: 'outgoing', started_at: Time.now, finished_at: Time.now
      call_log3 = CallLog.make id: 3, address: 1000, channel: channel, call_flow: call_flow, direction: 'incoming', started_at: Time.now, finished_at: Time.now
      call_log4 = CallLog.make id: 4, address: 1000, channel: channel, call_flow: call_flow, direction: 'outgoing', started_at: Time.now, finished_at: Time.now
      call_log5 = CallLog.make id: 5, address: 1000, channel: channel, call_flow: call_flow, direction: 'incoming', started_at: Time.now, finished_at: Time.now
      call_log6 = CallLog.make id: 6, address: 1000, channel: channel, call_flow: call_flow, direction: 'outgoing', started_at: Time.now, finished_at: Time.now
