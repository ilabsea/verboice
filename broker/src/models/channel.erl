-module(channel).
-export([find_all_sip/0, find_all_twilio/0, domain/1, port/1, protocol/1, number/1, limit/1, broker/1, username/1, password/1, is_outbound/1, register/1, dtms_mode/1]).
