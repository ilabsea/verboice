...
-record(call_log, {id, account_id, project_id, finished_at, direction, address, state, created_at, updated_at, channel_id, started_at, schedule_id, not_before, call_flow_id, pbx_logs_guid, fail_reason, duration, retries, step_interaction, store_log_entries, prefix_called_number, parent_id, contact_id}).
